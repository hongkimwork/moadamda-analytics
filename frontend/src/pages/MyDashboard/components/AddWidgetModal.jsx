/**
 * 위젯 추가 모달 컴포넌트
 * 3단계 스텝: 카테고리 선택 → 지표 선택 → 기간 설정
 */

import React, { useState } from 'react';
import { Modal, Typography, Button, Radio, DatePicker, Checkbox, Steps } from 'antd';
import {
  PlusOutlined,
  ArrowLeftOutlined,
  ArrowRightOutlined,
...
import { DATA_SOURCES, WIDGET_PRESETS, DATE_PRESETS, getComparisonPeriod } from '../constants';
